...
<head>
    ...
    <meta content="portfolio,, Web Developer, Web Designer, Frontend Developer , html , css , javascript"
        name="keywords">
    <meta
        content="Hello world!! I'm a  Web Developer, Web Designer and Frontend Developer, welcome to my portfolio"
        name="description">
    <meta content="achref" name="author">
    <!-- Favicons -->
    <link href="" rel="icon">
...
<body id="page-top">
    ...
    <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll" href="#page-top"><img src="" width="50px" alt=""></a>
    ...
    <!--/ Intro Skew Star /-->
    <div id="home" class="intro route bg-image" style="background-image: url(img/luca-bravo-XJXWbfSo2f0-unsplash.jpg)">
        <div class="overlay-itro"></div>
        <div class="intro-content display-table">
            <div class="table-cell">
                <div class="container">
                    <h1 class="intro-title mb-4">I am achref elhour </h1>
                            ...
                            <div class="col-md-6">
                                <div class="row mt-5 pt-5">
                                    <div class="col-sm-6 col-md-5">
                                        <div class="about-img">
                                            <img src="img/achraf.jpg" width="150" class="img-fluid rounded b-shadow-a"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-7">
                                        <div class="about-info">
                                            <p><span class="title-s">Name: </span> <span> Achref elhour</span></p>
                                            <p><span class="title-s">Profile: </span> <span>full stack developer</span>
                                            </p>
                                            <p><span class="title-s">Email: </span> <span>Achraf.elhour1@gmail.com</span>
                                            </p>
                                            <p><span class="title-s">Phone: </span> <span>(+212) 642357080</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="more-info">
                                            ...
                                            <ul class="list-ico">
                                                <li><span class="ion-ios-location"></span> Q ettakadoum rue najib mahfoud N92 Youssoufia</li>
                                                <li><span class="ion-ios-telephone"></span> (+212)642357080</li>
                                                <li><span class="ion-email"></span>Achraf.elhour1@gmail.com</li>
                                            </ul>
                                        </div>
                                        <div class="socials">
                                            <ul>
